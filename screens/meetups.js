...
const Upcoming = () => {
  return (
    <View style={styles.container}>
      <Image source={require("../assets/gdg.png")} style={styles.roboImage} />
  ...
  return (
    <View style={styles.session}>
      <View style={styles.doctorInfo}>
        ...
        <View>
          <Text style={{ fontSize: 18, fontWeight: "600" }}>Yourstory Techsparks</Text>
        </View>
      </View>
      ...
      <View style={styles.sessionDetails}>
        <View style={styles.sessionDate}>
          <View style={{ flexDirection: "row", alignItems: "center", gap: 5 }}>
            ...
            <Text style={{ color: "#707070" }}>28th - 29th July ‘24</Text>
          </View>

          <View style={{ flexDirection: "row", alignItems: "center", gap: 5 }}>
            <MaterialCommunityIcons name="clock" size={20} color="#CDCDCD" />
            <Text style={{ color: "#707070" }}>9:00 PM - 6:00 PM</Text>
          </View>
        </View>
