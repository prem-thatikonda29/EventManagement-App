...
const Upcoming = () => {
  return (
    <View style={styles.container}>
      <Image source={require("../assets/Robo.png")} style={styles.roboImage} />
  ...
  return (
    <View style={styles.session}>
      <View style={styles.doctorInfo}>
        ...
        <View>
          <Text style={{ fontSize: 18, fontWeight: "600" }}>Ace of Hacks</Text>
        </View>
      </View>
      ...
      <View style={styles.sessionDetails}>
        <View style={styles.sessionDate}>
          ...
          <View style={{ flexDirection: "row", alignItems: "center", gap: 5 }}>
            ...
            <Text style={{ color: "#707070" }}>24 hours</Text>
          </View>
        </View>
